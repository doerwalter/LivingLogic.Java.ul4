...
public class KeywordMethodRenderS implements KeywordMethod
{
	...
	public static String call(EvaluationContext context, Template template, Map<String, Object> variables)
	{
		return template.renders(context, variables);
	}

	public static String call(EvaluationContext context, Object template, Map<String, Object> variables)
	{
