...
public class IfExpressionAST extends AST
{
	private AST objIf;
	private AST objCond;
	private AST objElse;

	public IfExpressionAST(Location location, int start, int end, AST objIf, AST objCond, AST objElse)
	{
	...
	public static AST make(Location location, int start, int end, AST objIf, AST objCond, AST objElse)
	{
		...
		return new IfExpressionAST(location, start, end, objIf, objCond, objElse);
	}
