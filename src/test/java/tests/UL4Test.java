...
public class UL4Test
{
	...
	public void function_format()
	{
		...
		checkTemplateOutput("Mo 24 Jan 2011 12:34:56", source3, "format", "%c", "data", t, "lang", "de");
		checkTemplateOutput("Mo 24 Jan 2011 12:34:56", source3, "format", "%c", "data", t, "lang", "de_DE");
		checkTemplateOutput("01/24/2011", source2, "format", "%x", "data", t);
		checkTemplateOutput("01/24/2011", source3, "format", "%x", "data", t, "lang", null);
		checkTemplateOutput("01/24/2011", source3, "format", "%x", "data", t, "lang", "en");
		checkTemplateOutput("24.01.2011", source3, "format", "%x", "data", t, "lang", "de");
		checkTemplateOutput("24.01.2011", source3, "format", "%x", "data", t, "lang", "de_DE");
