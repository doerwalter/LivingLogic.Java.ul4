...
public class UL4Test
{
	...
	{
		checkTemplateOutput("(gurk)", "<?def bracket(content, prefix='(', suffix=')')?><?printx prefix?><?render content()?><?printx suffix?><?end def?><?renderblocks bracket()?><?def content?>gurk<?end def?><?end renderblocks?>");
	}
